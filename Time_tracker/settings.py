...
SECRET_KEY = 'django-insecure-$2!1&u-6+lb^8!yql8c_m)m=ei@pt)z11z4t-7ub_4c0dv#d9m'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'time_tracking/templates/time_tracking/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
